...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        self.starting=["Unvisited","Unvisited","Unvisited","Unvisited"]
    ...
    def getStartState(self):
        ...
        space)
        """
        return (self.startingPosition,self.starting)
        "*** YOUR CODE HERE ***"
    ...
    def getNextState(self, state, action):
        ...
        nextx, nexty = int(x + dx), int(y + dy)
        "*** YOUR CODE HERE ***"
        #print("Valid move",(nextx,nexty))
        new_node=nextx, nexty
        #print("message",new_node,self.walls)
        if new_node not in self.walls:
            return (nextx,nexty)
        else:
            return False
        util.raiseNotDefined()
...
def cornersHeuristic(state, problem):
    ...
    while final_value!=0:
        ...
        current_state=new_states[list_to_create.index(value_of_min)]

        del new_states[list_to_create.index(value_of_min)]
    ...
    #find which corner is nearest

    #return final_value # Default to trivial soluti
